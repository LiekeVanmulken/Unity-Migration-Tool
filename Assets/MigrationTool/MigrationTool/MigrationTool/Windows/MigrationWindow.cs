...
namespace migrationtool.windows 
{
    ...
    public class MigrationWindow : EditorWindow
    {
        ...
        void OnGUI()
        {
            // if (GUILayout.Button("test file delete"))
            // {
            //     PREpackageImporter.RemoveOldPackageFiles("https://dl.dropbox.com/s/epqthul3drbnv29/191107-Prespective-1-0-0-77-BETA-RELEASE.unitypackage","https://dl.dropbox.com/s/r7hreeuovjj2act/191128-Prespective-1-1-83-1839-BETA-RELEASE.unitypackage");
            //     // PREpackageImporter.downloadPackageAndGetPath();
            // }
